...
| 目的 | 看这份 | 关键词 |
|---|---|---|
| **要交东西**（有 deadline） | [`docs/自学通关路线.md`](docs/自学通关路线.md) | 十周计划表、里程碑、调试阶梯、砍功能顺序 |
| **要懂东西**（没 deadline，想真学会） | [`docs/学习指南-读懂这个项目.md`](docs/学习指南-读懂这个项目.md) | 五层认知地图、精读顺序、七个验证实验、二十道自测题 |

- 做完整个项目约需 **90~110 人时**（每周 10h × 10 周）
- 只求搞懂约需 **25~35 人时**，因为不追求功能完整
